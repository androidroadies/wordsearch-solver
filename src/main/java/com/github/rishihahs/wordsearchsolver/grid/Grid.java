...
/**
 * 
 * Interface for defining a grid used to store
 * the Wordsearch puzzle in.
 *
 */
public interface Grid {
	 ...
	 * 
	 * @param point The {@link java.awt.Point} at which the letter is at
	 * @return The letter
	 */
	 ...
	 * 
	 * @param point The point of the letter that has been marked as found
	 */
	public void markLetterAt(Point point);
	
	/**
	 * Checks if the given point
	 * is a valid point on the current grid
	 * 
